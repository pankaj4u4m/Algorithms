...
void printTree(Node *node1, Node *node2){
	...
	if(node1 == NULL){
		...
		while(current1 != NULL || current2 != NULL || !q1.empty() || !q2.empty()){
...
int main ( int argc, char *argv[] ) {
	//freopen("TwoBastPrintSortedOrder.cppin","r",stdin);
	Node *node1 = new Node();
	node1->value = 3;
	node1->left = new Node();
	node1->left->value = 1;
